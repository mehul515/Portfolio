...
const Contact = () => {
  ...
  const handleMessage = async (e) => {
    ...
    await axios
      .post(
        "https://mehul-kohad-portfolio-backend.onrender.com/message/send",
  ...
  return (
      <article id="contact" className="px-5 mt-20 sm:mx-auto w-full max-w-[1050px] flex flex-col gap-14">
        <div className="overflow-x-hidden">
          <div className="relative mb-8">
            ...
            tracking-[15px] mx-auto w-fit font-extrabold about-h1 text-tubeLight-effect"
              style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex md:mb-0 mb-10">
              <div className="min-w-[92%]">
                <div className="bg-gray-900 rounded-lg my-5 lg:w-[90%] md:w-[100%] sm:w-[100%] py-5 px-7">
                  <div className="inline bg-slate-700 w-10 h-10 p-[10px] rounded-[50%]">
                    <Phone size={26} className="inline w-6" />
                  </div>
                  &nbsp;&nbsp;&nbsp;7666491426
                </div>

                <div className="bg-gray-900 my-5 rounded-lg lg:w-[90%] md:w-[100%] sm:w-[100%] py-5 px-7">
                  <div className="inline bg-slate-700 w-10 h-10 p-[10px] rounded-[50%]">
                    <Mail size={26} className="inline w-6" />
                  </div>
                  &nbsp;&nbsp;&nbsp;mehulkohad@gmail.com
                </div>

                <div className="bg-gray-900 rounded-lg lg:w-[90%] md:w-[100%] sm:w-[100%] py-5 px-7">
                  <div className="inline bg-slate-700 w-10 h-10 p-[10px] rounded-[50%]">
                    <MapPin size={26} className="inline w-6" />
                  </div>
                  &nbsp;&nbsp;&nbsp;Dighori, Nagpur
                </div>
              </div>
              <div className="hidden md:flex w-1 h-92 bg-white"></div>
            </div>
