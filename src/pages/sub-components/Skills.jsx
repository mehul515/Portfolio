...
const Skills = () => {
  ...
  return (
    <div id="skills">
      <article className="px-5 mt-20 sm:mx-auto w-full max-w-[1050px] flex flex-col gap-14">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4">
              {skills &&
                skills.map((skill, idx) => {
                  return (
                    <Card className="h-fit p-7 flex flex-col justify-center items-center gap-3" key={idx}>
                      <img
                        src={skill.image}
                        alt="skill"
                        className="rounded-lg h-12 sm:h-24 w-auto"
                      />
